...
namespace HB.Common.Core.Framework.Helpers
{
    public static class TimeHelper
    {
        ...
        /// <param name=”timeStamp”></param>
        /// <returns></returns>
        public static DateTime GetTime(TimeSpan timeStamp)
        {
            DateTime dtStart = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1));
            long lTime = long.Parse(timeStamp + "0000000");
            TimeSpan toNow = new TimeSpan(lTime);
        ...
        public static long ConvertDateTimeUnix13(System.DateTime time)
        {
        ...
        /// <param name="biggerTime"></param>
        /// <returns></returns>
        public static int betweenSecondTimeCount(DateTime smallTime,DateTime biggerTime) {
            return (int)(biggerTime - smallTime).TotalSeconds;
        }
        /// <summary>
        /// 转成时间戳
        /// </summary>
        /// <param name="time"></param>
        /// <returns></returns>
        public static int ToUnix10(this DateTime time)
        {
